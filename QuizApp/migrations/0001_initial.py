# Generated by Django 2.1.7 on 2020-07-07 10:10
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='EasyQuestionAnwers',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('question', models.TextField(verbose_name='Question')),
                ('option_1', models.TextField(verbose_name='Type Option 1')),
                ('option_2', models.TextField(verbose_name='Type Option 2')),
                ('option_3', models.TextField(verbose_name='Type Option 3')),
                ('option_4', models.TextField(verbose_name='Type Option 4')),
                ('answer', models.CharField(choices=[('1', 'Option 1'), ('2', 'Option 2'), ('3', 'Option 3'), ('4', 'Option 4')], default='1', max_length=250)),
            ],
        ),
        migrations.CreateModel(
            name='HardQuestionAnwers',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('question', models.TextField(verbose_name='Question')),
                ('option_1', models.TextField(verbose_name='Type Option 1')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('marking', models.CharField(choices=[('same', 'Same Marking for all Category'), ('different', 'Different Marking for all Category')], default='same', max_length=250)),
                ...
                ('time_alloted', models.CharField(help_text='Time to be alloted for Quiz.', max_length=250, verbose_name='Time Alloted')),
                ...
                ('quiz_setter', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Quiz',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('neg', models.SmallIntegerField(default=0, help_text='Marks to be deducted on wrong answer. If no negative marking is to be opted then enter 0.', validators=[django.core.validators.MaxValueValidator(100)], verbose_name='Negative Marking')),
